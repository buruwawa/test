  ...
  {{-- end of modal --}}
                                                                            ...
                                                                            <div class="card-toolbar text-right">
                                                                               ...
                                                                               <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                  ...
                                                                                  <a href="{{ route('update-user',$user->id) }}" class="btn-success dropdown-item click-recovery" id="click-edit1" onclick="return confirm(id='Are you sure you want to Recovery this  {{$user->name}}')">Recovery</a>


                                                                               <form action="{{ route('user-register.destroy',$user->id) }}" method="POST">
                                                                                    @csrf
                                                                                    <input type="hidden" name="_method" value="delete">
                                                                                    <input type="submit" class="dropdown-item" value="Permanent delete" onclick="return confirm(id='Are you sure you want to delete Permanently this User?')">
                                                                                </form>
                                                                                </div>
                                                                                </div>
                                                                        </td>
