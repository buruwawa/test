...
<!--   <style>
.wawa-bgcolor{
background-color:#18684e !important;  
}
</style> -->
  ...
  @if($message)
            ...
            <div class="row">
                  ...
                  <div class="col-xl-12 col-md-12"><h5 class="title font-weight-bold text-center">Assign Roles to User-(AROU)</h5></div>

                <div class="col-xl-6 col-md-6">                       
                  <h5 class="title font-weight-bold text-center">Users List</h5>                    <div class="card card-custom gutter-b bg-white border-0">
                   <div class="card-body">                                
                       <form  method="post"  action="{{ route('assign-roles-user.store') }}" enctype="multipart/form-data">
                             @csrf                           
...
<div class="form-group">
     ...
     @isset($roles)
      ...
      <div class="row">
      <div class="col-xl-8 col-md-8 col-xs-8">{{$role->name}}</div>
     <div class="col-xl-4 col-md-4 col-xs-4"><input type="checkbox" name="roles[]" value="{{$role->id}}">
     </div>                     
   </div> 
   @endforeach 
   @endisset
